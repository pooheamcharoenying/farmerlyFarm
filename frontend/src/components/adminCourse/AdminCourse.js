...
export default function AdminCourse() {
    ...
    return (
        ...
        <ScrollContainer hideScrollbars={false} vertical={false} className="flex-row overflow-x-auto flex md:flex-wrap md:overflow-hidden mt-10 w-4/5" >
           ...
           <div className="bg-white flex justify-center rounded-lg py-4 -mb-2" style={{width:"200px"}}><div className="text-bold mr-2">Active</div> <Switch defaultChecked={courseData.courseActive} checkedChildren="Yes" unCheckedChildren="No" onClick={(courseStatus)=>UpdataCourseStatusAction(GlobalHook,courseData.courseName,courseStatus)}/></div>
