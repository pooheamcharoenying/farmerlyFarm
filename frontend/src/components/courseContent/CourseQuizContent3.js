...
export default function CourseQuizContent() {
  ...
  const [getUserClick,setUserClick] = useState(0)
  ...
  function handleQuizSelect(index) {
    ...
    setUserClick(getUserAnsBank[getQuestionPool[index].questionId])
  }
  ...
  function handleAnsSubmit(){
    ...
    if(GlobalHook.getGlobalLessionSelect.mediaEtc1){
     if(getUserAnsBank[getQuestionPool[getSelectQuestion].questionId]){
  ...
  function CalUserAnsStatus(){
    ...
    if(GlobalHook.getGloblaQuizAnswerCorrect == getUserAnsBank[getQuestionPool[getSelectQuestion].questionId]){
      // getUserAnsBank[getQuestionPool[getSelectQuestion].questionId]
        ...
        >
          ...
          <button
            ...
            onClick={() => {
              ...
              FetchQuestionWhenSelectAction(GlobalHook, getQuestionPool[0].questionId);
              setSelectQuestion(0)
              setUserAnsBank({})
              setUserClick(null)
