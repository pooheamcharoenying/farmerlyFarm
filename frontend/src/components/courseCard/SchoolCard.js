...
export default function SchoolCard({schoolData}) {
    ...
    return (
        ...
        <div className="text-center text-3xl mt-2 font-bold text-gray-900 px-2 capitalize text2line flex justify-center items-center" style={{minHeight:"60px",maxHeight:"60px"}}>
           {schoolDataLocal.schoolName || ""}
